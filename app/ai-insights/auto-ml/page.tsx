...
function FeatureSelectionStep({ modelConfig, setModelConfig, onNext, onBack }) {
  ...
  const allFeatures = {
    'dataset1': [
      ...
      { name: 'internet_service', type: 'categorical', importance: 0.65, description: 'Customer internet service provider' },
      { name: 'online_security', type: 'categorical', importance: 0.62, description: 'Whether the customer has online security service' },
      { name: 'payment_method', type: 'categorical', importance: 0.58, description: 'The customer payment method' },
