  ...
  return (
    <AppLayout>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <Card title="Critical Priority" className="flex flex-col">
        ...
        <Card title="Overdue" className="flex flex-col">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <Card title="Create Mission" className="p-4 flex flex-col items-center text-center">
        ...
        <Card title="KPI Dashboard" className="p-4 flex flex-col items-center text-center">
          <div className="text-3xl mb-2">📊</div>
        ...
        <Card title="AI Recommendations" className="p-4 flex flex-col items-center text-center">
          <div className="text-3xl mb-2">🤖</div>
